...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="{{ route('mahasiswa.tugas.index') }}" class="nav-item"><i class="bi bi-clipboard-check"></i> Tugas</a>
    <a href="{{ route('mahasiswa.absensi.index') }}" class="nav-item active"><i class="bi bi-calendar-check"></i> Absensi</a>
